  ...
  return (
    <div className="relative inline-flex ml-3">
      ...
      >
        ...
        >
          <div className="text-xs font-semibold text-gray-400 uppercase pt-1.5 pb-2 px-4">ようこそ</div>
          <ul>
            <li className="border-b border-gray-200 last:border-0">
              <Link
                ...
                onClick={() => setDropdownOpen(!dropdownOpen)}
              >
                <span className="block text-sm mb-2">🚀<span className="font-medium text-gray-800"></span> Sint occaecat cupidatat non proident</span>
